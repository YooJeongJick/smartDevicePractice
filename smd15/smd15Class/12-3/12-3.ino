...
const String rest_api_key = "83f6dd54eaf7a1361223a240ce7f194e";
String access_token = "pOU2SuMBSi0xcWtQrr7Zf6s9lFxFm2wuAAAAAQoqJQ8AAAGQGqi5heQ1KlcE_6bt";
String refresh_token = "1XDEB_C8XHBPCs58gq5yqKFFJkn85as6AAAAAgoqJQ8AAAGQGqi5guQ1KlcE_6bt";

#define MsgSendInterval 60  // 60 * 60 초, 즉 한시간 간격으로 전송
